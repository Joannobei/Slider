  ...
  return (
    <div>
      ...
      <div className=' lg:w-[1281px] h-[606px]  m-auto mt-[88px] bg-[#F3F4F6] rounded-md '>
        <div className='w-[1157px] m-auto lg:flex py-[129px] justify-between'>
          <img className='lg:w-[424px] lg:h-[352px] w-[250px] h-[208px]  ' src={productComputer} alt="" />
          <div className='lg:w-[542px] w-[322px] '>
            <p className='font-bold lg:text-[38px] text-[24px]  '>Expense Management</p>
            <p className='w-[full] mt-[48px] text-[20px] '>Use our comprehensive software to manage your business spend and reconcile receipts in real time.
      ...
      <div className=' w-[1281px] h-[606px]  m-auto lg:mt-[88px] bg-[#F3F4F6] rounded-md '>
        <div className='w-[1147px] m-auto lg:flex py-[129px] justify-between'>
