    ...
    return (
        <div className="bg-[#F3F4F6]">
            ...
            <div className="lg:flex justify-center lg:space-y-0 space-y-[24px] w-[255px] m-auto lg:w-[1274px] relative  -top-[80px] ">
                <img className='lg:w-[414px] h-[157px] w-[255px] lg:h-[255px]' src={product1} alt="conference-hall" />
                <img className='lg:w-[414px] h-[157px] w-[255px] lg:h-[255px]' src={product2} alt="conference-hall" />
                <img className='lg:w-[414px] h-[157px] w-[255px] lg:h-[255px]' src={product3} alt="doctor&patient" />
            </div>
        </div>
